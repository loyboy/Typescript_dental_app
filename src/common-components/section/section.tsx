	...
	render() {
		return (
			...
			>
				...
				<IconButton
					style={{ zIndex: 9,position: 'absolute', top: '5px', left: '5px' }}
					
					iconProps={{
						iconName: this.props.image ? this.props.image : ""
					}}
				...
				<h3
					...
					style={{ position: 'absolute', top: 0, left: 20, zIndex: 10, padding: '6px 16px', borderBottom: 'none' }}
				>
					{this.props.title}
				</h3>
				<div style={{ marginTop: this.show ? 20 : 0 }}>

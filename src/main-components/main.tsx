...
export class MainView extends React.Component<{}, {}> {
  private handleWindowBeforeUnload = (ev: BeforeUnloadEvent): string => {
    ev.preventDefault();
    const message = "Unsaved changes. Are you sure?";
      ...
      return (
        ...
        >
          <AsyncComponent
            ...
            loader={async () => {
              const HeaderView = (await import("./header")).HeaderView;
              const UserPanelView = (await import("./user")).UserPanelView;
 ...
 //    window.removeEventListener("beforeunload", this.handleWindowBeforeUnload);
  ...
  render() {
    return <ErrorBoundaryView key={status.step}>{this.view}</ErrorBoundaryView>;
  }
}

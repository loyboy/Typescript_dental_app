...
export class HomeView extends React.Component<{}, MyState> {
  ...
  componentDidMount() {
    ...
    console.log("Todays appoint: "+ this.time.day + "  "+ this.time.month + "  " + this.time.year  )
  }
      ...
      <div className="home p-l-10 p-r-10">
        <div className="container">
          ...
          <div style={{ float: 'right', width: '30%' }}>
            ...
            <Dropdown
              options={
                [{ id: 'overall', val: 'overall' }, { id: 'analytics', val: 'analytics' }, { id: 'dashboard', val: 'dashboard' }].map((data) => ({
                  key: data.id,
                  text: data.val,
                })) as any
              }
                      ...
                      <PieChartComponent
                        ...
                        {...{
                          data: [
                            ...
                            { label: text("In Progress: " + this.calculatePercentileVisitsTime('InProgress')), value: this.calculatePercentileVisitsTime('InProgress') },
              ...
              <Row>
                ...
                <Col md={8}>
                  ...
                  <SectionComponent title={'Visits'} image={'CalendarMirrored'} >
                    <h3> <b> Total :</b>  {appointments.list.filter((item, i) => item.patientID !== "" && new Date(item.date).toDateString() === new Date().toDateString()).length}</h3>
                    <PieChartComponent
                      height={400}
                      {...{
                        data: [

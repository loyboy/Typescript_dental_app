...
export class SettingsPage extends React.Component<{}, {}> {
  ...
  doExport = () => {
    ...
    if (isConfirmed) {
      ...
      let newpat = patient.map((pat: Patient) => {
        return {
          Id: pat._id,
          Name: pat.name,
    ...
    return (
      ...
      <Toggle
         ...
         {/* <Toggle
          ...
          <Toggle
            onText={text("Instructions enabled")}
            offText={text("Instructions module disabled")}
            defaultChecked={!!setting.getSetting("module_instructions")}
            onChange={(ev, val) => {
              setting.setSetting("module_instructions", val ? "enable" : "");
            }}
            disabled={!this.canEdit}
          />

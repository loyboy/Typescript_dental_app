...
@observer
export class EndoCaseSheetPanelV2 extends React.Component<{
  orthoCase: EndoCase;
}> {
...
{/*
          <TextField
            ...
            min={0}
            max={180}
            value={this.props.orthoCase.workinglen.toString()}
            onChange={(ev, v) => {
              this.props.orthoCase.workinglen.push(v!) ;
            }}
            type="number"
        ...
        <SectionComponent title={text(`Problems`)}>
          ...
          {this.props.orthoCase.computedProblems.length === 0 ? (
            ...
            <DetailsList
              ...
              compact
              items={[
                ...this.props.orthoCase.computedProblems.map((x, i) => [
                  `${i + 1}. ${x}`
                ])
              ]}

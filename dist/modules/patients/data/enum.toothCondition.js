...
export const Diagnosis = {
    K00: {
        ...
        diagnosis: [
            ...
            {
                id: "K00.5",
                value: "Hereditary disturbances in tooth structure, not elsewhere classified"
            },
            {
                id: "K00.6",
    ...
    K04: {
        ...
        diagnosis: [
            ...
            {
                id: "K04.6",
                value: "Periapical abscess with sinusRoot canal treatment,endodontic,obturate,abcess"
            },
            {
                id: "K04.7",
            ...
            {
                id: "K04.9",
                value: "Other and unspecified diseases of the pulp and periapical tissues"
            }
        ]
    },
    K05: {
    ...
    K06: {
        ...
        diagnosis: [
            ...
            {
                id: "K06.2",
                value: "Gingiva and edentulous alveolar ridge lesions associated with trauma"
            },
            {
                id: "K06.3",
                value: "Other specified disorders of the gingiva and edentulous alveolar ridge"
            },
            {
                id: "K06.4",
                value: "Disorder of the gingiva and edentulous alveolar ridge, unspecified"
            }
        ]
    },
    K07: {
    ...
    K08: {
        ...
        diagnosis: [
            ...
            {
                id: "K08.1",
                value: "Loss of teeth due to extraction, accident or local periodontal disease"
            },
            {
                id: "K08.2",
    ...
    K13: {
        ...
        diagnosis: [
            ...
            {
                id: "K13.2",
                value: "Leukoplakia and other disturbances of the oral epithelium including tongue"
            },
            {
                id: "K13.3",
    ...
    ZZCodes: {
        ...
        diagnosis: [
            ...
            {
                id: "Z53.2",
                value: "Procedure not carried out because of patient's decision for other and unspecified reasons"
            }
        ]
    }
};
...
export const procedureList = [
    ...
    },
    {
        ...
        parentIndex: 8,
        order: 2,
        value: "Traditional metal braces - Requires extraction (fee for extraction is not included)",
        defaultPrice: 1750
    },
    {
        parentId: "orthodontics",
        parentIndex: 8,
        order: 5,
        value: "Traditional ceramic braces - Requires extraction (fee for extraction is not included",
        defaultPrice: 2590
    },
    {
        parentId: "orthodontics",
    ...
    },
    {
        ...
        parentIndex: 8,
        order: 3,
        value: "Traditional metal braces - Complicated case: lost of molar, root treated teeth etc",
        defaultPrice: 2500
    },
    {
        parentId: "orthodontics",
    ...
    },
    {
        ...
        parentIndex: 8,
        order: 6,
        value: "Traditional ceramic braces - Complicated case: lost of molar, root treated teeth etc",
        defaultPrice: 2800
    },
    //9 Surgery
    {
...
export function conditionToColor(c) {
    if (c === "compromised") {
        return "#FFCDD2";
    }
    else if (c === "endo") {
...
//# sourceMappingURL=enum.toothCondition.js.map